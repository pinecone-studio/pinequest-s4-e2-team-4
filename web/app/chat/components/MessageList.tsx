...
const SUGGESTIONS = [
  {
    ...
    prompt: "Хөвсгөл нуур руу 3 өдөр аялах дэлгэрэнгүй төлөвлөгөө гаргаж өгнө үү."
  },
  {
    title: "🚗 Говийн аялал",
    desc: "Машинаар аялахад юу бэлдэх вэ?",
    prompt: "Говь руу машинаар аялахад анхаарах зүйлс болон бэлтгэл хангахад шаардлагатай зүйлсийг зөвлөнө үү."
  },
  {
    title: "🏕️ Тэрэлжийн амралт",
    desc: "Очих шилдэг амралтын газрууд",
    prompt: "Горхи Тэрэлжийн байгалийн цогцолбор газарт байрлах, амрахад тохиромжтой шилдэг амралтын газруудыг санал болгоорой."
  }
];
    ...
    <>
      ...
      <div className="flex-shrink-0 border-t border-slate-100 bg-white/95 backdrop-blur-md px-4 pb-6 pt-2">
        ...
        <p className="mt-2 text-center text-[10px] font-medium text-slate-400">
          Enter-ээр илгээнэ · Shift+Enter шинэ мөр
        </p>
      </div>
    </>
  );
